...
class ReportFragment : Fragment(R.layout.fragment_report_monthly) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val line =
            Line(values, isCubic = true, hasLabels = false, hasPoints = false, pointRadius = 2)
        ...
        binding.reportButtons.setContent {
            MdcTheme {
                ...
                val range by viewModel.reportRange.observeAsState()
                ReportButtons(
                    rangeLabel = "${range?.first} - ${range?.second}",
